...
INSERT INTO "article" ("id", "user_id", "upvote_count", "downvote_count", "author", "title", "description", "sourceName", "url", "urlToImage", "publishAt", "content")
VALUES
-- (
--   1,
--   1,
...
INSERT INTO "comment" ("id", "user_id", "article_id", "comment", "date_commented")
VALUES
  (
    1,
    1,
...
INSERT INTO "article_vote" ("id", "voteType", "user_id", "article_id")
VALUES 
(
  1,
  "up",
